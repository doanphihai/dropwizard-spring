...
/**
 * Created by hdoan on 09/05/2014.
 */
public class AbstractSpringService<T extends SpringServiceConfiguration> extends Service<T> {
    public static void main(String[] args) throws Exception {
        new AbstractSpringService().run(args);
    }
